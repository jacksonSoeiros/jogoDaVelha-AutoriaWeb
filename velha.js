...
// function jogoempatado(quadrado) {
//   if (quadrado != checaVencedor) {
...
function mudarCorQuadrado(quadrado1, quadrado2, quadrado3) {
  quadrado1.style.background = "#22ac22";
  quadrado2.style.background = "#22ac22";
  quadrado3.style.background = "#22ac22";
}
...
function checaSequencia(quadrado1, quadrado2, quadrado3) {
  ...
  /*AINDA NA TENTATIVA DA FUNCAO EMPATE! */
  //   } else {
  //     jogoempatado();
  //   }
